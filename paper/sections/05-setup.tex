...
removal, and a kernel$\times$trace interaction grid. All axes, the interaction, and
whole-modality removal are reported in \S\ref{sec:results-trace}--\S\ref{sec:results-interact}.
