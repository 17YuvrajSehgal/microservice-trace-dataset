...
`RESULTS-agent-sanitygate-masked.md`, `RESULTS-nonllm-baselines.md`; transcripts +
sha256 bundles on `/project/def-naser2/yuvraj17/microservice-trace-dataset/artifacts/`.
