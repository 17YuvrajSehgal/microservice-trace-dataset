...
![All 360 runs, one square each](charts/2-every-run.png)
...
![All 360 window scores](charts/3-window-raw.png)
...
![Score without vs with a blueprint](charts/4-room-to-improve.png)
...
![Time and tokens for every run](charts/5-cost-raw.png)
