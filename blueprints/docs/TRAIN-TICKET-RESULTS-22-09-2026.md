...
![Blueprint effect by problem and measure](charts-tt/1-blueprint-effect.png)
...
![All 360 runs, one square each](charts-tt/2-every-run.png)
...
![All 360 window scores](charts-tt/3-window-raw.png)
...
![Score without vs with a blueprint](charts-tt/4-room-to-improve.png)
...
![Time and tokens for every run](charts-tt/5-cost-raw.png)
...
```
/scratch/yuvraj17/stratatrace/results/q2-tt/review/review-<problem>.md
```
