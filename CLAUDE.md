...
| Path | What |
|---|---|
| `READING-ORDER.md` | **Which docs to read and in what order** — ~120 markdown files exist and not all are current. Names the duplicates, the superseded ones, and what to skip |
